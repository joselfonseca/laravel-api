  ...
  "<span class="hljs-attribute">meta</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">pagination</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">links</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">previous</span>": <span class="hljs-value"><span class="hljs-string">"http://example.com/api/users?page=1"</span></span>,
        "<span class="hljs-attribute">next</span>": <span class="hljs-value"><span class="hljs-string">"http://example.com/api/users?page=2"</span></span>,
        "<span class="hljs-attribute">last</span>": <span class="hljs-value"><span class="hljs-string">"http://example.com/api/users?page=2"</span>
      </span>}
    </span>}
  </span>}
...
</div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 09 Feb 2017</p></div></div></div></div><script>/* eslint-env browser */
