...
</section></div><div class="middle"><div id="auth-register" class="resource"><h3 class="resource-heading">Register <a href="#auth-register" class="permalink">&para;</a></h3><p>Use this endpoint to register a new user from the client consuming the API.</p>
...
</div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 03 Jan 2021</p></div></div></div></div><script>/* eslint-env browser */
